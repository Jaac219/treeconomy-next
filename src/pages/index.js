              ...
              <div className="col-xl-12">
                <ul id="menu-preheader" className="menu">
                  <li id="menu-item-667" className="menu-item menu-item-type-post_type menu-item-object-page menu-item-667"><a
                      href="https://www.treeconomy.com.co/es/quienes-somos/">Nuestro Equipo</a></li>
                  ...
                  <li id="menu-item-608" className="menu-item menu-item-type-custom menu-item-object-custom menu-item-608"><a
                      href="https://app.treeconomy.com.co/account/login/">Acceso</a></li>
                </ul>
              </div>
            </div>
          </div>
            ...
            <div className="row d-flex align-items-center">
              <div className="col-xl-2 col-lg-2">
                <div className="logo logo-animado" id="myGallery">
                  <a href="https://www.treeconomy.com.co/es">
        ...
        <div className="col-xl-12 col-12">
          <div className="position-text">
            <h2 className="tittle-banner">
              ...
              <span className="titulo-2">Construyendo una sostenibilidad </span>
              <span className="titulo-3"> Rentable</span>
            </h2>
            <a href="https://www.treeconomy.com.co/es/como-funciona/" className="who-button">Como Funciona</a>
            <p className="texto-general">Plataforma de inversión, que te ofrece la posibilidad de obtener retornos
              superiores al 12% anual, mientras haces un gran impacto positivo al mundo a través de la forestación.
            </p>

            <ul>
              <li>
                <a href="https://www.facebook.com/TheTREEconomy" target="_blank"><i
                    className="fab fa-facebook-f"></i></a>
              </li>
              <li>
                <a href="https://www.instagram.com/thetreeconomy/" target="_blank"><i
                    className="fab fa-instagram"></i></a>
              </li>
              <li>
                <a href="https://twitter.com/TheTreeconomy" target="_blank"><i className="fab fa-twitter"></i></a>
              </li>
            </ul>
        ...
        <div className="row">
          <div className="col-xl-12">
            ...
            <div className="contenedor-video">
              {/* <iframe width="100%" height="100%" frameborder="0" rel="0"
                allow="accelerometer; autoplay; encrypted-media; gyroscope; picture-in-picture" allowfullscreen
                data-src="https://www.youtube.com/embed/L-P50TKq0-I?rel=0" className="lazyload"
