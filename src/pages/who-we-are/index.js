          ...
          <div class="row d-flex align-items-center">
            <div class="col-xl-6">
              ...
              <p class="description">
                ...
                trayectoria de más de 30 años en la industria forestal, así como
                experiencia relevante en consultoría estratégica y el sector
                financiero. Creemos que las inversiones sostenibles liderarán el
                futuro de las finanzas y contribuirán a mitigar el cambio
                climático.{' '}
              </p>
            </div>
            <div class="col-xl-6">
          ...
          <div class="row d-flex align-items-end">
            <div class="col-xl-4">
              <div class="explicacion-box">
                ...
                />
                <p>
                  Treeconomy es una plataforma de inversión innovadora, que ha
                  revolucionado el modelo ordinario de reforestación para
                  adaptarse a las nuevas eras de inversión. Nuestro modelo de
                  reforestación consiste en áreas protegidas donde la siembra,
                  mantenimiento y producción de madera es eficiente y
                  responsable. Con Treeconomy, esperará rendimientos anuales de
                  las inversiones entre el 12 % y el 15 %, que pueden duplicarse
                  en comparación con otras inversiones a largo plazo, como los
            ...
            <div class="col-xl-4">
              <div class="explicacion-box">
                ...
                <p>
                  Somos un equipo de profesionales apasionados con un objetivo
                  común; lograr transformar la industria de la reforestación y
                  eliminar sus limitantes de ingreso. Nuestro equipo tiene una
                  experiencia combinada de 30 años en la industria forestal,
                  consultoría y finanzas. Creemos que las inversiones
                  sostenibles liderarán el futuro de las finanzas y ayudarán a
                  contribuir a la mejora del cambio climático.
                </p>
              </div>
            </div>
            <div class="col-xl-4">
        ...
        <div class="container-fluid">
          <div class="row d-flex align-items-center">
            ...
            <div class="col-xl-6">
              ...
              <p></p>
              <p>
                A medida que aumenta la demanda de productos derivados de los
                árboles, los niveles de deforestación también aumentan y esto ha
                creado problemas para el medio ambiente, las comunidades y la
                economía. Nosotros como sociedad, necesitamos este recurso para
                continuar con nuestra forma de vida, pero ¿Cómo podemos hacer
                que este proceso sea sostenible? ¿Cómo seguir utilizando este
                recurso natural de una manera responsable? Estas preguntas
                estuvieron en nuestras mentes durante meses, y así es como
                Treeconomy cobró vida.
              </p>
              <p>
                Un método de inversión de reforestación responsable que une a
                personas de todo el mundo para lograr un objetivo común; Una
                inversión sostenible que protege el medio ambiente y proporciona
                una estabilidad financiera a los futuros inversionistas.
              </p>
              <p>
                Los tipos de inversión sostenibles son el futuro de nuestra
                economía, y la combinación de procesos tecnológicos innovadores
                con métodos de reforestación responsables es la forma en que
                nosotros en Treeconomy estamos contribuyendo a un futuro mejor.
              </p>
            </div>
          </div>
        </div>
