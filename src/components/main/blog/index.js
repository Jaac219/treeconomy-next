          ...
          <div className="col-xl-4">
            ...
            <div className={`contenedor-info`}>
              <img
                ...
                className="lazyload"
                src="https://treeconomy.com.co/wp-content/uploads/2020/05/undraw_video_streaming_yyld.png"
              />
              <p>
                Treeconomy te ofrece la oportunidad de comenzar a hacer que tus
                ahorros sean importantes. ¡Con una inversión mensual recurrente
                que comienza desde $ 25 dólares, podrás lograr la estabilidad
                financiera que siempre has soñado! Además, gracias a nuestra
                plataforma web podras tener la flexibilidad y transparencia
                necesaria para administrar tu inversión desde cualquier lugar,
                en cualquier momento. Fácil. Seguro.
              </p>
              <ul className="botones">
                ...
                <li>
                  <a href="http://18.217.49.56/" className="especial"></a>
                </li>
              </ul>
            </div>
          </div>
        ...
        <div className="blog-info">
          <div className="row">
            <div className="col-xl-6">
              ...
              <p></p>
              <p>
                Nos enorgullecemos de comprender la situación crítica que
                representa el cambio climático y de cómo podemos hacer una
                diferencia investigando y compartiendo información correcta y
                oportuna a nuestros usuarios. A continuación, podrás encontrar
                información valiosa sobre el medio ambiente, la industria
                forestal, y políticas que están impactando nuestro planeta.
                Fácil. Confiable. Oportuno
              </p>
            </div>
          </div>
            ...
            <div className="col-xl-12">
              <div className="slide-blog-home">
                <div
                  ...
                  onClick={() =>
                    (location.href =
                      'https://www.treeconomy.com.co/es/las-3-oportunidades-de-inversion-sostenible-que-debes-conocer/')
                  }
                >
                  <p className="texto-preview">
                    <a href="https://www.treeconomy.com.co/es/las-3-oportunidades-de-inversion-sostenible-que-debes-conocer/">
                      Las 3 oportunidades de inversi&oacute;n sostenible que
                      debes conocer.
                    </a>
                    <span>
                      En la actualidad, cada vez son m&aacute;s las personas que
                      buscan invertir su dinero en proyectos que no solo les
                      generen ganancias, sino que tambi&eacute;n tengan un
                      impacto positivo en el medio ambiente y la sociedad.En
                      este art&iacute;culo te presentamos tres oportunidades de
                      inversi&oacute;n sostenible, entre ellas, la
                      inversi&oacute;n en reforestaci&oacute;n comercial con
                      Treeconomy. &nbsp;&hellip;{' '}
                      <a
                  ...
                  <div className="share-but">
                    <div className="addtoany_shortcode">
                      <div
                        ...
                        data-a2a-title="Las 3 oportunidades de inversi&oacute;n sostenible que debes conocer."
                      >
                        <a
                ...
                <div
                  ...
                  onClick={() =>
                    (location.href =
                      'https://www.treeconomy.com.co/es/la-inversion-en-proyectos-sostenibles-una-forma-de-tener-un-impacto-positivo-en-la-sociedad/')
                  }
                >
                  <p className="texto-preview">
                    <a href="https://www.treeconomy.com.co/es/la-inversion-en-proyectos-sostenibles-una-forma-de-tener-un-impacto-positivo-en-la-sociedad/">
                      La inversión en proyectos sostenibles, una forma de tener
                      un impacto positivo en la sociedad.
                    </a>
                    <span>
                      La inversión en proyectos sostenibles, como la
                      reforestación comercial, puede tener un impacto positivo
                      en la sociedad y la comunidad local. Los proyectos
                      sostenibles no solo generan empleos y oportunidades
                      económicas, sino que también pueden ayudar a mejorar la
                      calidad de vida de las personas y proteger el medio
                      ambiente. Uno de los mayores beneficios…{' '}
                      <a
                        className="view-article"
                ...
                <div
                  ...
                  onClick={() =>
                    (location.href =
                      'https://www.treeconomy.com.co/es/la-responsabilidad-social-corporativa-impulsando-la-adquisicion-de-bonos-de-carbono-por-parte-de-las-empresas/')
                  }
                >
                  <p className="texto-preview">
                    <a href="https://www.treeconomy.com.co/es/la-responsabilidad-social-corporativa-impulsando-la-adquisicion-de-bonos-de-carbono-por-parte-de-las-empresas/">
                      “La responsabilidad social corporativa impulsando la
                      adquisición de bonos de carbono por parte de las empresas”
                    </a>
                    <span>
                      Las empresas adquirieron bonos de carbono por varias
                      razones, incluyendo la responsabilidad social corporativa,
                      la gestión del riesgo y la mejora de la reputación de la
                      empresa. Los bonos de carbono son una herramienta
                      importante para ayudar a las empresas a cumplir sus
                      objetivos de sostenibilidad y reducción de emisiones de
                      gases de efecto…
                      <a
                        className="view-article"
                ...
                <div
                  ...
                  onClick={() =>
                    (location.href =
                      'https://www.treeconomy.com.co/es/por-que-invertir-en-treeconomy-es-una-apuesta-segura-para-el-futuro/')
                  }
                >
                  <p className="texto-preview">
                    <a href="https://www.treeconomy.com.co/es/por-que-invertir-en-treeconomy-es-una-apuesta-segura-para-el-futuro/">
                      “Por qué invertir en Treeconomy es una apuesta segura para
                      el futuro”
                    </a>
                    <span>
                      Somos una empresa dedicada a la inversión en bosques y
                      reforestación en Colombia. A través de su modelo de
                      negocio, en Treeconomy buscamos impulsar el desarrollo
                      sostenible y la conservación de los bosques en el país, al
                      mismo tiempo que ofrecemos una alternativa de inversión
                      rentable y responsable, avanzando de la mano de la
                      tecnología…{' '}
                      <a
                        className="view-article"
                ...
                <div
                  ...
                  onClick={() =>
                    (location.href =
                      'https://www.treeconomy.com.co/es/el-poder-del-interes-compuesto-como-invertir-hoy-para-construir-riqueza-a-largo-plazo/')
                  }
                >
                  <p className="texto-preview">
                    <a href="https://www.treeconomy.com.co/es/el-poder-del-interes-compuesto-como-invertir-hoy-para-construir-riqueza-a-largo-plazo/">
                      “El poder del interés compuesto: cómo invertir hoy para
                      lograr riqueza a largo plazo”
                    </a>
                    <span>
                      El interés compuesto es uno de los conceptos financieros
                      más importantes que cualquier persona que desee invertir
                      su dinero debe entender. Es una herramienta poderosa para
                      riqueza a largo plazo y es construir esencial para lograr
                      metas financieras a largo plazo, como la jubilación o la
                      compra de una casa. ¿Qué es el interés compuesto?…{' '}
                      <a
                        className="view-article"
                ...
                <div
                  ...
                  onClick={() =>
                    (location.href =
                      'https://www.treeconomy.com.co/es/sustainable-wood-production-a-renewable-resource/')
                  }
                >
                  <p className="texto-preview">
                    <a href="https://www.treeconomy.com.co/es/sustainable-wood-production-a-renewable-resource/">
                      Producción sostenible de madera: Un recurso renovable.
                    </a>
                    <span>
                      La lucha por conservar los bosques en Colombia siempre
                      está activa y una de las maneras más latentes para
                      continuar, es promover la producción responsable de
                      madera, el cual protege y Contribuye a los recursos
                      naturales y el desarrollo económico con sostenibilidad.
                      ¿Qué es la madera sostenible? La madera sostenible es uno
                      de los…{' '}
                      <a
                        className="view-article"
                  ...
                  <div className="share-but">
                    <div className="addtoany_shortcode">
                      <div
                        ...
                        data-a2a-title="Producci&oacute;n sostenible de madera: Un recurso renovable."
                      >
                        <a
                          className="a2a_button_facebook"
                ...
                <div
                  ...
                  onClick={() =>
                    (location.href =
                      'https://www.treeconomy.com.co/es/4-razones-para-invertir-en-arboles/')
                  }
                >
                  <p className="texto-preview">
                    <a href="https://www.treeconomy.com.co/es/4-razones-para-invertir-en-arboles/">
                      4 Razones para invertir en Arboles
                    </a>
                    <span>
                      El primer grupo de oportunidades provenientes de la
                      siembra de árboles deriva de las estrategias del convenio
                      para el crecimiento verde en Colombia…
                    </span>
                  </p>
                  <img
                    alt=""
                  ...
                  <div className="share-but">
                    <div className="addtoany_shortcode">
                      <div
                        ...
                        data-a2a-title="4 Reasons to invest in Trees"
                      >
                        <a
                          className="a2a_button_facebook"
                ...
                <div
                  ...
                  onClick={() =>
                    (location.href =
                      'https://www.treeconomy.com.co/es/treeconomy-in-the-spotlight-reforestation-investment/')
                  }
                >
                  <p className="texto-preview">
                    <a href="https://www.treeconomy.com.co/es/treeconomy-in-the-spotlight-reforestation-investment/">
                      Treeconomy en el punto de mira: inversión en reforestación
                    </a>
                    <span>
                      Durante los últimos ocho meses, personas de todo el mundo
                      han visto amenazado su libre albedrío durante una pandemia
                      que obligó a todos a permanecer dentro de sus hogares los
                      próximos meses. Nosotros, en Treeconomy, hemos notado los
                      efectos que esto creó en la moral de las personas y su
                  ...
                  <div className="share-but">
                    <div className="addtoany_shortcode">
                      <div
                        ...
                        data-a2a-title="Treeconomy in the Spotlight ? Reforestation investment"
                      >
                        <a
                          className="a2a_button_facebook"
                ...
                <div
                  ...
                  onClick={() =>
                    (location.href =
                      'https://www.treeconomy.com.co/es/forest-plantation-and-the-quest-to-achieve-environmental-sustainability/')
                  }
                >
                  <p className="texto-preview">
                    <a href="https://www.treeconomy.com.co/es/forest-plantation-and-the-quest-to-achieve-environmental-sustainability/">
                      Plantaciónes forestales y la búsqueda para lograr la
                      sostenibilidad ambiental.
                    </a>
                    <span>
                      En los últimos años se ha intensificado la discusión sobre
                      la sustentabilidad ambiental de las plantaciones
                      comerciales…
                    </span>
                  </p>
                  <img
                  ...
                  <div className="share-but">
                    <div className="addtoany_shortcode">
                      <div
                        ...
                        data-a2a-title="Forest Plantation and The Quest to Achieve Environmental Sustainability."
                      >
                        <a
                          className="a2a_button_facebook"
                ...
                <div
                  ...
                  onClick={() =>
                    (location.href =
                      'https://www.treeconomy.com.co/es/commercial-tree-plantations-to-tackle-climate-change/')
                  }
                >
                  <p className="texto-preview">
                    <a href="https://www.treeconomy.com.co/es/commercial-tree-plantations-to-tackle-climate-change/">
                      Plantaciones comerciales para combatir el Cambio Climático
                    </a>
                    <span>
                      Parece haber un gran consenso a la hora de medir la
                      relación entre las plantaciones comerciales y el
                  ...
                  <div className="share-but">
                    <div className="addtoany_shortcode">
                      <div
                        ...
                        data-a2a-title="Commercial tree plantations to tackle Climate Change"
                      >
                        <a
                          className="a2a_button_facebook"
